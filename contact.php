...
<head>
  ...
  <title>Shahnewaz rahi Portfolio</title>
...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <div><h1 class="text-success"><i class="fas fa-envelope mr-1"></i> Email: shahnewazrahi@gmail.com</h1></div>
        <div><h3 class="text-success"><i class="fas fa-phone mr-3"></i> Phone No: 01536187265</h3></div>
      </div>
    </div>
  </div>
